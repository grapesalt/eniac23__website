        ...
        return (
          <Link to={`/events/${event.permalink}`}>
            <div className="relative overflow-hidden bg-cover bg-no-repeat">
              ...
              <div className="absolute md:rounded-md bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-0 transition duration-300 ease-in-out hover:opacity-70"></div>
            </div>
          </Link>
        );
      })}
